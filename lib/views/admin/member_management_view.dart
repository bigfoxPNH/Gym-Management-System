...
class MemberManagementView extends StatelessWidget {
  ...
  Widget _buildStatCard(String title, String count, Color color, VoidCallback onTap, bool isSelected) {
    return Expanded(
      child: InkWell(
        onTap: onTap,
  ...
  Widget _buildUsersList(MemberManagementController controller) {
    return Obx(() {
      final usersToShow = controller.filteredUsers.isNotEmpty || 
                         controller.searchQuery.value.isNotEmpty ||
                         controller.selectedRole.value != null
          ? controller.filteredUsers
          : controller.users;

      if (usersToShow.isEmpty && (controller.searchQuery.value.isNotEmpty || controller.selectedRole.value != null)) {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if ((user.dob != null) || (user.address != null && user.address!.isNotEmpty)) ...[
        ...
        content: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _buildDetailRow('Ngày sinh', user.dob != null 
                ? '${user.dob!.day.toString().padLeft(2, '0')}/'
                  '${user.dob!.month.toString().padLeft(2, '0')}/'
                  '${user.dob!.year}'
                : ''),
  ...
  void _showMemberFormDialog(
    ...
    final dobController = TextEditingController(text: user?.dob != null 
        ? '${user!.dob!.day.toString().padLeft(2, '0')}/'
          '${user.dob!.month.toString().padLeft(2, '0')}/'
          '${user.dob!.year}'
        : '');
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: const [
                      DropdownMenuItem(value: 'member', child: Text('Hội viên')),
  ...
  void _showDeleteConfirmDialog(
    ...
    Get.dialog(
      AlertDialog(
        ...
        content: Text('Bạn có chắc chắn muốn xóa thành viên "${user.fullName}"?\n\nHành động này không thể hoàn tác.'),
        actions: [
          TextButton(
            onPressed: () => Get.back(),
            child: const Text('Hủy'),
