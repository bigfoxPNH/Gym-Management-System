...
class MoMoQRPaymentView extends StatefulWidget {
  final String orderId;
  final int amount;
  final String orderInfo;

  const MoMoQRPaymentView({
    super.key,
  ...
  @override
  State<MoMoQRPaymentView> createState() => _MoMoQRPaymentViewState();
}

class _MoMoQRPaymentViewState extends State<MoMoQRPaymentView> {
        ...
        actions: [
          TextButton(
            onPressed: () {
              ...
              if (status.isSuccess) {
                Navigator.of(context).pop(); // Also close payment screen
              }
            },
  ...
  Widget _buildPaymentContent() {
    ...
    if (_paymentResult?.qrCodeUrl != null) {
      return Center(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
