      ...
      child: Column(
        children: [
          SwitchListTile(
            ...
            subtitle: const Text('Nhận lời nhắc tập luyện và cập nhật'),
          ...
          SwitchListTile(
            ...
            subtitle: const Text('Nhận báo cáo tiến trình hàng tuần'),
            value: false,
            onChanged: (value) => _showComingSoonSnackBar(),
          ),
        ],
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text('Trò chuyện với chúng tôi trên Zalo'),
            trailing: const Icon(Icons.open_in_new, size: 16),
      ...
      child: Column(
        children: [
          ...
          ListTile(
            ...
            subtitle: const Text(
              'Xem chính sách riêng tư đầy đủ của chúng tôi',
            ),
            trailing: const Icon(Icons.arrow_forward_ios, size: 16),
